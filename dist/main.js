...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__combineReducers__ = __webpack_require__(211);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bindActionCreators__ = __webpack_require__(212);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_Subscription__ = __webpack_require__(196);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(48);
...
var _Stock = __webpack_require__(263);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_shallowEqual__ = __webpack_require__(198);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wrapMapToProps__ = __webpack_require__(47);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(21), __webpack_require__(44)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wrapMapToProps__ = __webpack_require__(47);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            _react2.default.createElement(_reactRouterDom.Route, { path: '/home', component: _Form2.default }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/datatable/:id', component: _DataTable2.default })
          )
        )
      );
    }
...
var Form = function (_Component) {
  ...
  function Form() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Form.__proto__ || Object.getPrototypeOf(Form)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      e.preventDefault();
      _this.setState({ buttonClicked: true });
      _this.props.getStockDataForAnalysis(_this.state.url).then(function (res) {
        _this.setState({ plainUrl: res.data.plainUrl });
      });
      ...
      // });
    }, _this.handleRowClick = function (selectedRowId) {
      return _this.setState({ selectedRowId: selectedRowId });
    }, _this.handleGoClick = function (id) {
      var plainUrl = _this.state.plainUrl;

      _this.props.saveStockDataForAnalysis(id, plainUrl).then(function () {
        _this.props.history.push('/datatable/' + id);
      });
  ...
  _createClass(Form, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          buttonClicked = _state.buttonClicked,
          selectedRowId = _state.selectedRowId;
      var stockData = this.props.stockData;

      return _react2.default.createElement(
        'div',
        { className: 'base ' + (buttonClicked ? 'base-expanded' : '') },
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', {
              ...
              onChange: function onChange(e) {
                return _this2.handleChange(e, 'url');
              }
            }),
            _react2.default.createElement('input', { className: 'btn submit-button', type: 'submit', value: 'Go' })
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'data-container' },
          stockData.allStocks.map(function (row, rowIndex) {
            return _react2.default.createElement(_index2.default, {
              key: 'key_row_' + rowIndex,
              row: row,
              rowIndex: rowIndex,
              handleRowClick: _this2.handleRowClick,
              selectedRowId: selectedRowId,
              handleGoClick: _this2.handleGoClick
            });
          })
        )
      );
...
function mapDispatchToProps(dispatch) {
  return _extends({
    ...
    getStockDataForAnalysis: _Actions.getStockDataForAnalysis,
    saveStockDataForAnalysis: _Actions.saveStockDataForAnalysis
  }, dispatch));
}
...
exports.getAnalysedData = exports.saveStockDataForAnalysis = exports.getStockDataForAnalysis = undefined;
...
var getStockDataForAnalysis = exports.getStockDataForAnalysis = function getStockDataForAnalysis(url) {
  return function (dispatch, getState) {
    return _axios2.default.get('/api/stock/data', {
      params: {
        url: url
      }
    }).then(function (res) {
...
var saveStockDataForAnalysis = exports.saveStockDataForAnalysis = function saveStockDataForAnalysis(id, plainUrl) {
  return function (dispatch, getState) {
    return _axios2.default.post('/api/stock/stock', {
      id: id,
      plainUrl: plainUrl
    }, {
      timeout: 10000
...
var getAnalysedData = exports.getAnalysedData = function getAnalysedData(id) {
  return function (dispatch, getState) {
    return _axios2.default.get('/api/stock/stockdata', {
      params: {
        id: id
      }
    }).then(function (res) {
...
// module
exports.push([module.i, ".btn {\n  background: #e67e22;\n  padding: 10px 30px;\n  border: none;\n  outline: none;\n  font-weight: 900; }\n\n.base {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 100vh;\n  flex-direction: column; }\n  .base.base-expanded .data-container {\n    flex: 9;\n    overflow: auto;\n    width: 100%;\n    padding: 10px; }\n  .base.base-expanded .form-wrapper form {\n    height: 100%;\n    width: 100%;\n    flex-direction: row; }\n    .base.base-expanded .form-wrapper form .submit-button {\n      flex: 1;\n      margin: 0px 15px; }\n    .base.base-expanded .form-wrapper form .main-input {\n      flex: 4;\n      margin: 0px 15px; }\n  .base .form-wrapper {\n    display: flex;\n    flex: 2;\n    width: 100%;\n    align-items: center;\n    justify-content: center; }\n    .base .form-wrapper * {\n      transition: all 2s ease-in-out; }\n    .base .form-wrapper form {\n      background-color: #3498db;\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      justify-content: center;\n      height: 200px;\n      width: 70%;\n      transition: width .1s; }\n      .base .form-wrapper form * {\n        transition: width .5s; }\n      .base .form-wrapper form .submit-button {\n        display: flex;\n        color: #fff;\n        justify-content: center; }\n      .base .form-wrapper form .main-input {\n        display: flex;\n        padding: 10px;\n        margin-bottom: 10px;\n        width: 80%; }\n  .base .group-title {\n    margin: 30px;\n    text-align: center;\n    font-size: 24px;\n    font-family: lato;\n    font-weight: 900;\n    color: #1abc9c; }\n  .base .stock-row {\n    display: flex;\n    background-color: #2ecc71;\n    color: #ecf0f1;\n    font-weight: 600;\n    margin-bottom: 10px;\n    padding: 12px 0px;\n    cursor: pointer;\n    box-shadow: 2px 2px 15px rgba(0, 0, 0, 0.4); }\n    .base .stock-row .select-wrapper {\n      display: none; }\n    .base .stock-row:hover {\n      box-shadow: 2px 2px 15px rgba(0, 0, 0, 0.6); }\n    .base .stock-row.stock-row-selected {\n      box-shadow: 2px 2px 15px rgba(0, 0, 0, 0.6);\n      position: relative; }\n      .base .stock-row.stock-row-selected .select-wrapper {\n        height: 25px;\n        width: 25px;\n        display: flex;\n        align-items: center;\n        justify-content: center;\n        border-radius: 50%;\n        position: absolute;\n        right: 10px;\n        background-color: #fff;\n        border: 2px solid #d35400;\n        color: #d35400; }\n    .base .stock-row .stock-column {\n      padding: 5px;\n      flex: 1; }\n      .base .stock-row .stock-column.stock-column-name {\n        flex: 4; }\n      .base .stock-row .stock-column.stock-column-date {\n        flex: 2; }\n", ""]);
  ...
  _createClass(DataRow, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          selectedRowId = _props.selectedRowId,
          handleGoClick = _props.handleGoClick;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          null,
          row.name ? _react2.default.createElement(
            'div',
            {
            ...
            _react2.default.createElement(
              'span',
              { className: 'stock-column stock-column-id' },
              ' ',
              row.id,
              ' '
            ),
            _react2.default.createElement(
              'span',
              { className: 'stock-column stock-column-name' },
              ' ',
              row.name,
              ' '
            ),
            _react2.default.createElement(
              'span',
              { className: 'stock-column stock-column-price' },
              ' ',
              row.nav,
              ' '
            ),
...
var _DataRow = __webpack_require__(269);

var _DataRow2 = _interopRequireDefault(_DataRow);

var _DataTableHeader = __webpack_require__(271);

var _DataTableHeader2 = _interopRequireDefault(_DataTableHeader);

var _MainTable = __webpack_require__(272);
...
var DataTable = function (_Component) {
  ...
  function DataTable() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DataTable.__proto__ || Object.getPrototypeOf(DataTable)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(DataTable, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          getAnalysedData = _props.getAnalysedData,
          match = _props.match;
    ...
    value: function render() {
      var _props2 = this.props,
          stockData = _props2.stockData,
          stockInfo = _props2.stockInfo;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(_MainTable2.default, { stockInfo: stockInfo })
        ),
        _react2.default.createElement(_DataTableHeader2.default, {
          row: {
            date: "Date",
            id: "Id",
            name: "Name",
        ...
        stockData && stockData.map(function (row, rowIndex) {
...
function mapDispatchToProps(dispatch) {
  return _extends({
    ...
    getAnalysedData: _Actions.getAnalysedData
  }, dispatch));
}
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          row.name ? _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              { className: 'stock-column stock-column-date' },
              ' ',
              (0, _moment2.default)(new Date(row.date)).format('D-MMM-YYYY'),
              ' '
            ),
            _react2.default.createElement(
              'span',
              { className: 'stock-column stock-column-nav-calc' },
              ' ',
              row.nav120 && row.nav120.toFixed(2),
              ' '
            ),
            _react2.default.createElement(
              'span',
              { className: 'stock-column stock-column-nav-calc' },
              ' ',
              row.nav120 && row.nav120Ratio.toFixed(2),
              ' '
            ),
            _react2.default.createElement(
              'span',
              { className: 'stock-column stock-column-nav-calc' },
              ' ',
              row.nav200 && row.nav200.toFixed(2),
              ' '
            ),
            _react2.default.createElement(
              'span',
              { className: 'stock-column stock-column-nav-calc' },
              ' ',
              row.nav200 && row.nav200Ratio.toFixed(2),
              ' '
            )
          ) : _react2.default.createElement(
            'div',
...
var MainTable = function (_Component) {
  ...
  _createClass(MainTable, [{
    ...
    value: function render() {
      ...
      var min120 = stockInfo.min120,
          max120 = stockInfo.max120,
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    "td",
                    null,
                    (min120 + xFactor120 * 4).toTwoDecimals()
                  ),
                  _react2.default.createElement(
                    "td",
                    null,
                    (min200 + xFactor200 * 4).toTwoDecimals()
                  )
                ),
                _react2.default.createElement(
                  "tr",
                  ...
                  _react2.default.createElement(
                    "td",
                    null,
                    (min120 + xFactor120 * 3).toTwoDecimals()
                  ),
                  _react2.default.createElement(
                    "td",
                    null,
                    (min200 + xFactor200 * 3).toTwoDecimals()
                  )
                ),
                _react2.default.createElement(
                  "tr",
                  ...
                  _react2.default.createElement(
                    "td",
                    null,
                    (min120 + xFactor120 * 2).toTwoDecimals()
                  ),
                  _react2.default.createElement(
                    "td",
                    null,
                    (min200 + xFactor200 * 2).toTwoDecimals()
                  )
                ),
                _react2.default.createElement(
                  "tr",
                  ...
                  _react2.default.createElement(
                    "td",
                    null,
                    (min120 + xFactor120 * 1).toTwoDecimals()
                  ),
                  _react2.default.createElement(
                    "td",
                    null,
                    (min200 + xFactor200 * 1).toTwoDecimals()
                  )
                ),
                _react2.default.createElement(
                  "tr",
...
// module
exports.push([module.i, ".data-table .stock-row {\n  border-bottom: 1px solid #d3d3d3;\n  display: flex;\n  flex-direction: row; }\n  .data-table .stock-row .stock-column {\n    padding: 10px;\n    flex: 1; }\n    .data-table .stock-row .stock-column.stock-column-name {\n      flex: 8;\n      white-space: nowrap;\n      text-overflow: ellipsis;\n      overflow: hidden; }\n    .data-table .stock-row .stock-column.stock-column-date {\n      flex: 2; }\n\n.stock-info-row {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  padding: 10px;\n  border: 1px solid #d3d3d3; }\n\n.analytics-table-container {\n  display: flex;\n  padding: 30px;\n  flex-direction: row;\n  justify-content: space-between; }\n  .analytics-table-container div {\n    flex: 1;\n    justify-content: center;\n    align-items: center; }\n    .analytics-table-container div td {\n      padding: 5px 12px;\n      border: 1px dotted; }\n", ""]);
...
var _StockData = __webpack_require__(280);
